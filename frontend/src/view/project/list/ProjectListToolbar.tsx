...
const ProjectToolbar = (props) => {
  ...
  const hasPermissionToImport = useSelector(
    projectSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="project-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="project-list-toolbar-export-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=project">
